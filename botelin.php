...
<body>
  ...
  <form action="mostrardatos.php" method="post">
    ...
    <div id="interes">
      ...
      <input type="checkbox" name="interesado[]" value="phyton"/> Phyton<br>
      <input type="checkbox" name="interesado[]" value="java"/> Java<br>
      <input type="checkbox" name="interesado[]" value="php"/> PHP<br>
      <input type="checkbox" name="interesado[]" value="js"/> Javascript<br>
      <input type="checkbox" name="interesado[]" value="ruby"/> Ruby<br>
      <input type="checkbox" name="interesado[]" value="c"/> C#<br><br>
    </div>
    <div id="dia">
